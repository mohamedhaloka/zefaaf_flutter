                  ...
                  : controller.loadingReplyPhoto.value
                      ...
                      : controller.user.value.requestMyMobile == "0" &&
                          ...
                          : buildIconRequestMobile(
                              context: context,
                              viewMyMobile: controller.user.value.viewMyMobile,
                              requestMyMobile:
              ...
              SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildListDelegate([
                      ...
                      dataList(
                        ...
                        (controller.user.value.allowMobile == "0" &&
                            ...
                            : controller.user.value.allowMobile == "1"
                                ...
                                : '',
                        lightMode,
                        button: controller.appController.userData.value
                                        .packageLevel! <=
                                    3 ||
                                (controller.user.value.allowMobile == "0" &&
                                    controller.user.value.requestMobile == "0")
                            ? ElevatedButton(
                    ...
                    section([
                      dataList(
                          "age".tr, "${controller.user.value.age}", lightMode),
                      dataList(
                          "socialStatus".tr,
                          controller.loading.value
                              ...
                              : controller.user.value.gender == 0
                                  ? getUserData(
                                      ...
                                      controller.user.value.mariageStatues ?? 0,
                    ...
                    section([
                      ...
                      dataList(
                          ...
                          lightMode,
                          visible:
                              controller.user.value.gender == 1 ? true : false),
                      dataList(
                          "smoke".tr,
                    ...
                    section([
                      ...
                      dataList(
                          ...
                          lightMode),
                      dataList(
                          "job".tr, "${controller.user.value.job}", lightMode),
                      dataList(
                          "intro".tr,
                          controller.loading.value
                              ? ""
                    ...
                    section([
                      dataList(
                          '', controller.user.value.aboutOther ?? '', lightMode,
                          oneTitle: true),
                    ], "عن شريك الحياة")
                  ]),
                ),
